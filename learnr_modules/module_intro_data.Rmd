...
<br>
Determine what type of data each of the following is. In addition, with your group, come up with THREE different potential values for the variable. Use the example to help guide you:
...
quiz(caption = "",
     ...
     question("What type of data is *the length of a centipede*?",
     ...
     question("What type of data is *the movie time in seconds*?",
              answer("Numeric discrete "),
              answer("Numeric continuous", correct = TRUE),
              answer("Categorical nominal"),
              answer("Categorical ordinal"),
     ...
     question("What type of data is the *amount of sugar in an ice cream cone*?",
              answer("Numeric discrete", correct = TRUE),
              answer("Numeric continuous"),
              answer("Categorical nominal"),
              answer("Categorical ordinal"),
